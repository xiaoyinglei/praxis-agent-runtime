...
from agent_runtime.core.goal_contract import GoalCompatibilityConfig
...
from agent_runtime.core.turn_contracts import (
    ToolManifest,
...
AGENT_CHECKPOINT_MSGPACK_ALLOWLIST: tuple[tuple[str, ...], ...] = (
    ("agent_runtime.core.messages", "ModelMessage"),
    ("agent_runtime.core.messages", "ToolCall"),
    ("agent_runtime.core.messages", "StopReason"),
    ("agent_runtime.core.messages", "ToolUseResult"),
    ("agent_runtime.core.context", "AgentRunConfig"),
    ("agent_runtime.core.definition", "ToolPolicy"),
    ("agent_runtime.core.human_input", "HumanInputRequest"),
    ("agent_runtime.core.human_input", "HumanInputResponse"),
    ("agent_runtime.core.human_input", "ToolCallSummary"),
    ("agent_runtime.core.output_models", "ValidatedFinalOutput"),
    ("agent_runtime.core.runtime_diagnostics", "RuntimeDiagnostic"),
    ("agent_runtime.core.runtime_diagnostics", "ToolCallMetrics"),
    ("agent_runtime.core.runtime_diagnostics", "AgentLatencyProfile"),
    ("agent_runtime.core.model_request", "ModelCallRecord"),
    ("agent_runtime.core.turn_contracts", "ToolCallPlan"),
    ("agent_runtime.core.turn_contracts", "ToolManifest"),
    ("agent_runtime.core.turn_contracts", "ToolManifestEntry"),
    ("agent_runtime.core.goal_contract", "GoalConstraint"),
    ("agent_runtime.core.goal_contract", "GoalCompatibilityConfig"),
    ("agent_runtime.core.goal_contract", "GoalContractEvaluation"),
    ("agent_runtime.core.goal_contract", "GoalContractIssue"),
    ("agent_runtime.core.goal_contract", "GoalDeliverable"),
    ("agent_runtime.core.goal_contract", "GoalSpec"),
    ("agent_runtime.memory.models", "ContextBudgetSnapshot"),
    ("agent_runtime.memory.models", "EvictedStateItem"),
    ("agent_runtime.memory.models", "ExtractedFact"),
    ("agent_runtime.memory.models", "ExternalizedToolOutput"),
    ("agent_runtime.memory.models", "MessageBatchPayload"),
    ("agent_runtime.memory.models", "MemoryBudgetSnapshot"),
    ("agent_runtime.memory.models", "MemoryPolicy"),
    ("agent_runtime.memory.models", "MemoryRecord"),
    ("agent_runtime.memory.models", "MemoryRef"),
    ("agent_runtime.memory.models", "StateChannelReplacement"),
    ("agent_runtime.memory.models", "ToolErrorDetailPayload"),
    ("agent_runtime.memory.models", "WorkingSummary"),
    ("agent_runtime.loop.state", "LoopPause"),
    ("agent_runtime.loop.state", "LoopTerminal"),
    ("agent_runtime.loop.state", "LoopTransition"),
    ("agent_runtime.loop.state", "ModelTurn"),
    ("agent_runtime.loop.state", "ModelTurnDraft"),
    # File manifest (file-first processing)
    ("agent_runtime.file_manifest", "FileManifest"),
    ("agent_runtime.file_manifest", "FileManifestEntry"),
    ("agent_runtime.file_manifest", "SheetPreview"),
    ("agent_runtime.file_manifest", "ColumnPreview"),
    ("agent_runtime.primitive_ops", "StructuredProbeOutput"),
    ("agent_runtime.primitive_ops", "StructuredTableProbe"),
    ("agent_runtime.primitive_ops", "CandidateHeaderRow"),
    ("agent_runtime.loop.state", "StopHookFeedback"),
    # ── PR3: PendingToolCall v2 + ToolCallLedger ──
    ("agent_runtime.loop.state", "PendingToolCall"),
    ("agent_runtime.loop.state", "ToolCallLedger"),
    ("agent_runtime.loop.state", "ToolCallLedgerEntry"),
    # ── PR1: typed sub-state convergence ──
    ("agent_runtime.loop.substate", "DeferredToolState"),
    ("agent_runtime.loop.substate", "FinishState"),
    ("agent_runtime.loop.substate", "MemoryState"),
    ("agent_runtime.loop.substate", "PlanState"),
    ("agent_runtime.loop.substate", "StopHookFeedback"),
    ("agent_runtime.loop.stop_hooks", "StopHookOutcome"),
    ("agent_runtime.loop.stop_hooks", "StopVerdict"),
    ("agent_runtime.planning", "AgentPlan"),
    ("agent_runtime.planning", "PlanEvent"),
    ("agent_runtime.planning", "PlanStep"),
    ("agent_runtime.skills.models", "LoadedSkill"),
    ("agent_runtime.skills.models", "LoadedSkillRef"),
    ("agent_runtime.skills.models", "SkillInvocation"),
    ("agent_runtime.skills.models", "SkillManifest"),
    ("agent_runtime.skills.models", "SkillSource"),
    ("agent_runtime.skills.models", "SkillState"),
    ("agent_runtime.tools.executor", "ExecutionStatus"),
    ("agent_runtime.tools.executor", "ToolExecutionRecord"),
    ("agent_runtime.tools.tool", "ArtifactReference"),
    ("agent_runtime.tools.tool", "ToolCall"),
...
class _AgentJsonPlusSerializer(JsonPlusSerializer):
    """Apply runtime-owned checkpoint decoding before the standard hook."""
...
def _normalize_loaded_state(state: LoopState) -> LoopState:
    ...
    from agent_runtime.loop.substate import DeferredToolState
...
def _migrate_legacy_state(raw: dict[str, Any]) -> LoopState:
    ...
    if "pending_loop_tool_calls" in raw:
        ...
        from agent_runtime.loop.state import PendingToolCall as NewPendingToolCall
    ...
    if raw_pending:
        from agent_runtime.core.turn_contracts import ToolCallPlan as NewToolCallPlan
        from agent_runtime.loop.state import PendingToolCall as NewPendingToolCall
    ...
    from agent_runtime.loop.state import ToolCallLedger as NewToolCallLedger
